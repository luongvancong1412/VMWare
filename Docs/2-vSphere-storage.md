...
|---|---|---|---|---|
Loại Storage|Data Stored in fixed-size blocks in a fixed arrangement-ideal for enterprise Apps & Databases.<br>Fully integrated with Servers.<br>Specific location on Memory or Disks|Data stored as files in hierarchically nested folders - ideal for active working documents.<br>Fully managed-Network Attached Storage (NAS)<br>Specific folder in fixed logical Order|Data stored as objects in scalable buckets-ideal for unstructured big data, analytics and archiving.<br>For any Application store any type & any amount of data for any duration & retrieve it as often as needed.<br>Flexible Container Size, No Platform dependency.
Examples|Pen drive, Hard disk,<br>SSD, Flash drives Amazon EC2 Instance Store<br>Amazon EBS|Shared files and folders<br>Unstructured data <br>Amazon EFS|Dropbox<br>Amazon S3<br>Amazon Glacier
Protocol(Storage is<br>consumed via protocol)|FC, FCOE<br>SCSI, ISCSI<br>SATA|TCP/IP<br>Network File Share (NFS)<br>Server Message Block (SMB)<br>Common Internet File System (CIFS)|TCP/IP<br>http,<br>Representational state transfer (REST)<br>Simple Object Access Protocol (SOAP)|
Interface|Operating System,<br>Direct Attached Storage (DAS)<br>Storage Area Network (SAN)|User|Program(API)
Performance|High|Medium|Low|
Storage Location|On-Premises, Private Cloud|On-Premises, Private Cloud|On-Premises, Private Cloud, Public Cloud & Hybrid|
